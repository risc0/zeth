...
use zeth_primitives::transactions::{
    ethereum::{EthereumTxEssence, TransactionKind}, EthereumTransaction, Transaction, TxEssence
};
...
pub fn generate_transactions(tx_list: &[u8], anchor_tx: EthersTransaction) -> Vec<EthersTransaction> {
...
pub fn generate_transactions_2(tx_list: &[u8], anchor_tx: Transaction<EthereumTxEssence>) -> Vec<Transaction<EthereumTxEssence>> {
    // Decode all the transactions in the tx list
